// src/app/who-we-serve/for-legal/page.tsx
        ...
        <section className="py-16 md:py-24 bg-gradient-to-b from-purple-50 to-white">
          <div className="container max-w-6xl space-y-4 mx-auto text-center">
            ...
            <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl text-purple-950">
              Ensure Compliance in Every Country
            </h1>
            <p className="mx-auto mt-4 max-w-[800px] text-lg text-purple-800/80 md:text-xl">
              Hire internationally with confidence. VerticalSync helps you generate locally compliant contracts and stay up-to-date with changing labor laws, minimizing risk and ensuring you meet your legal obligations everywhere you operate.
            </p>
          </div>
        </section>
