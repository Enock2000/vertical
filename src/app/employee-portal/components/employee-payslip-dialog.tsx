...
export function EmployeePayslipDialog({ employee, payrollDetails, companyName, payslipDate, children }: EmployeePayslipDialogProps) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Your payslip for {formattedPayslipDate}
          </DialogDescription>
        </DialogHeader>
            ...
            <div>
              ...
              <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>({currencyFormatter.format(payrollDetails.loanDeduction)})</span>
                </div>
                )}
                ...
                <div className="flex justify-between">
                  ...
                  <span>({currencyFormatter.format(payrollDetails.unpaidLeaveDeduction)})</span>
                </div>
                )}
                <div className="flex justify-between">
